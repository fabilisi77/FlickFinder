...
import com.example.flickfinder.core.BaseViewHolder
import com.example.flickfinder.data.model.Movie
import com.example.flickfinder.databinding.MovieItemBinding
...
class MovieAdapter (private val movieList: List<Movie>,private val itemClickListener: OnMovieClickListener) : RecyclerView.Adapter<BaseViewHolder<*>>() {
    ...
    private inner class MovieViewHolder(private val binding: MovieItemBinding, val context: Context) :
